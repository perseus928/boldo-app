...
import { View, SafeAreaView, ScrollView, TouchableOpacity, Image, Platform, PermissionsAndroid } from "react-native";
    ...
    return (
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 15, paddingHorizontal: 10 }}>
          ...
          <Text blackColor style={{ flex: 1, marginLeft: 20, fontSize: 20, textAlign: 'center' }}> {Utils.translate("post.share-post")} </Text>
